...
$CUDA_PATH='/opt/cuda';
$HSA_PATH='/usr';
$HIP_CLANG_PATH=`bash -c "dirname \$(which clang)"`;
chomp($HIP_CLANG_PATH);
$HIP_CLANG_RESOURCE_DIR=`clang -print-resource-dir`;
chomp($HIP_CLANG_RESOURCE_DIR);
$HIP_CLANG_INCLUDE_PATH="$HIP_CLANG_RESOURCE_DIR/include";
