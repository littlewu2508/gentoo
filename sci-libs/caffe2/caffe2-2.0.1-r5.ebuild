...
RDEPEND="
	...
	rocm? (
		>=dev-util/hip-5.1
		>=dev-libs/rccl-5.1[${ROCM_USEDEP}]
		>=sci-libs/rocThrust-5.1[${ROCM_USEDEP}]
		>=sci-libs/hipCUB-5.1[${ROCM_USEDEP}]
		>=sci-libs/rocPRIM-5.1[${ROCM_USEDEP}]
		>=sci-libs/miopen-5.1[${ROCM_USEDEP}]
		>=sci-libs/rocBLAS-5.1[${ROCM_USEDEP}]
		>=sci-libs/rocRAND-5.1[${ROCM_USEDEP}]
		>=sci-libs/hipSPARSE-5.2[${ROCM_USEDEP}]
		>=sci-libs/rocFFT-5.1[${ROCM_USEDEP}]
		>=sci-libs/hipFFT-5.1[${ROCM_USEDEP}]
		>=dev-util/roctracer-5.1
	)
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2.0.1-hip-frexp.patch
	"${FILESDIR}"/${PN}-2.0.1-findhip.patch
)
