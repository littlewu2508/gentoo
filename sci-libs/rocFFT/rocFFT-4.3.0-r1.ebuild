...
inherit cmake check-reqs flag-o-matic multiprocessing

DESCRIPTION="Next generation FFT implementation for ROCm"
HOMEPAGE="https://github.com/ROCmSoftwarePlatform/rocFFT"
GIT_COMMIT=573544b912d62285f706e01087b8d4d32f037477
SRC_URI="https://github.com/ROCmSoftwarePlatform/rocFFT/archive/${GIT_COMMIT}.tar.gz -> rocFFT-${GIT_COMMIT}.tar.gz"
...
BDEPEND="
	test? ( dev-cpp/gtest dev-libs/boos
	>=sci-libs/fftw-3
)"
